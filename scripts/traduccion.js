...
const translations = {
  ...
  en: {
    ...
    ticketLecheSoja: "Soy",
    ticketBebidaRooibos: "Rooibos (caffeine-free)",
    ticketLecheAvena: "Oat",
    ticketLecheCoco: "Coconut milk",
    step3: "STEP 3: CHOOSE SYRUP",
    ticketSiropeLimon: "Lemon",
    ticketSiropeMelonDulce: "Sweet Melon",
    ...
    ticketToppingMelonDulce: "Sweet Melon",
    ...
    ticketExtraBolaBomba: "Bomb Ball",
    ticketExtraPerlasCristal: "Crystal Pearls",
    ticketExtraTapiocaNegra: "Black Tapioca",
    ticketExtraJelly: "Jelly",
    ticketExtraEspumaQueso: "Cheese Foam",
    ...
    meloncitoIngredientes: "Jasmine tea, sweet melon, crystal pearls, cheese foam",
    meloncitoPrecio: "€5.00 / €5.50",
...
document.addEventListener("DOMContentLoaded", () => {
  let currentLang = "es";  // Idioma actual (español)
  const toggleButton = document.getElementById("toggleButton");
  const svgContainer = document.getElementById("svgContainer");

  toggleButton.addEventListener("click", () => {
    currentLang = currentLang === "es" ? "en" : "es";  // Cambia entre español y inglés
